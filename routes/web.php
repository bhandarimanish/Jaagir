...
Route::post('accept-reject/{id}', 'JobController@jobstatus')->name('accept.reject');
Route::get('jobs/applications/{id}', 'JobController@applicantview')->name('job.applicantview');
Route::get('jobs/alljobs', 'JobController@allJobs')->name('job.all');
Route::get('jobs/userjob', 'HomeController@usermyjob')->name('myjob.user');
...
//Internship
Route::get('/internships', 'JobController@internship')->name('internship');
