...
<div class="site-section">
      <div class="container">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5" style="font-family: cursive;">Popular Categories</h2>
          </div>
        <div class="row"  style="margin:0 auto">
          @foreach($categories as $category)
          <div class="category col-sm-6 col-md-4 col-lg-3 mb-4 rounded-top center" data-aos="fade-up" data-aos-delay="300">
