<style>
   .banner_image {
  background-image: url('external/images/register.jpg');
  height: 70%;
...
<div class="banner_image">
    <div class="content">
        <h4 style="color: white;"><a href="/"> Home </a>/Seeker Registration</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-6 mx-auto text-center  section-heading">
        <h2 class="mb-5 mt-5" style="font-family: Noto Sans, sans-serif;">Seeker Registration</h2>
    </div>
</div>
